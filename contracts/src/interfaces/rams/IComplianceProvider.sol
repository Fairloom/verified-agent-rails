...
// Copied verbatim from the ERC-8226 reference implementation
// (ethereum/ERCs assets/erc-8226, vendored at lib/rams-reference).
// Sole change: pragma ^0.8.29 -> ^0.8.26 to match this repo's pinned solc.
// Interface ids and ABI are unaffected by the pragma.
